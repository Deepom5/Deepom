    ...
    <Banner>
      <Video>
        <video
          ...
          loop
          autoPlay
          src={require("../../assets/video/2398150576313440492(1).mp4")}
        />
      </Video>
      <Canvas
        height={size.height}
      ...
      <BannerTitle variants={container} initial="initial" animate="animate">
        <Headline variants={item}>HEY,</Headline>
        <Headline variants={item}>GUYS</Headline>
      </BannerTitle>
      <p>Click on red 'O' of logo to see the magic</p>
    </Banner>
